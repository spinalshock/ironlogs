...
const TITLES: { min: number; name: string; color: string }[] = [
  { min: 500, name: 'Master of Iron', color: '#f44336' },
  { min: 250, name: 'Veteran of Steel', color: '#ff5722' },
  { min: 100, name: 'Iron Warrior', color: '#ffc107' },
  { min: 50, name: 'Iron Disciple', color: '#cddc39' },
  { min: 10, name: 'Barbell Initiate', color: '#4caf50' },
